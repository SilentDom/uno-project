...
public class UnoController {
    ...
    @FXML
    private ListView<Card> opponentCardList2;
    ...
    void drawCardButtonPressed(ActionEvent event) {
        try {
            game.givePlayerCard(game.getActingPlayer(game.getPlayerTurn())); // TODO: fix hardcode
            drawPlayerHand();
            drawOpponentHand(2);
        } catch (Exception e) {
    ...
    public void endTurnUpdates() {
        drawPlayerHand();
        drawOpponentHand(2);
        opponent2Hand.setText("Card Total: " + game.getActingPlayer(3).getPlayerHand().size() + " Turn: " + game.getPlayerTurn()
        + " Card Total: " + game.getActingPlayer(1).getPlayerHand().size() + " Turn: " + game.getPlayerTurn() + " Last Played: " + game.getDiscardPile().get(game.getDiscardPile().size()-2));
        updateDiscardDraw();
        if (game.isGameOver()) {
    ...
    public void initialize() {
        ...
        drawPlayerHand();
        drawOpponentHand(2);
        opponent2Hand.setText("Card Total: " + game.getActingPlayer(3).getPlayerHand().size() + " Turn: " + game.getPlayerTurn()+" Card Total: " + game.getActingPlayer(3).getPlayerHand().size() + " Turn: " + game.getPlayerTurn());
    }
}